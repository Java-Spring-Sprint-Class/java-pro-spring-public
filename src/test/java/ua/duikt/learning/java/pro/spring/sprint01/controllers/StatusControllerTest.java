...
class StatusControllerTest {
    ...
    void createStatus_Success() throws Exception {
        ...
        given(issueService.createStatus(1L, "To Do", StatusCategory.TO_DO))
                .willReturn(55L);
    ...
    void getStatuses_Success() throws Exception {
        ...
        given(issueService.getStatuses(10L)).willReturn(List.of(s1));
    ...
    void deleteStatus_Success() throws Exception {
        given(issueService.deleteStatus(1L)).willReturn(true);
    ...
    void deleteStatus_NotFound() throws Exception {
        given(issueService.deleteStatus(99L)).willReturn(false);
